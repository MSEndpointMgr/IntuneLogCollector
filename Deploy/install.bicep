...
//
// TODO: Application configuration settings 'TenantId' and 'SubscriptionId' are required for the Function App
// TODO: Ensure application configuration setting 'AllowedStorageAccounts' is set for Function App with value of storage account where the log rules file is placed
//
